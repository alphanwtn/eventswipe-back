...
public class UsersEventListEntityService {
    ...
    // getting all user's events that he liked, disliked or alerted (for one
    // specific status)
    ...
    // add an event to a user's eventList as liked, disliked or alerted
    ...
    // deleting an event from an user's eventList [use for tests purposes only]
    ...
    // modifying the status of an event in an user's eventlist to disliked
