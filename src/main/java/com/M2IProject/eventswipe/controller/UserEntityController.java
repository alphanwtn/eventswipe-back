...
public class UserEntityController {
	...
	public @ResponseBody String addNewUser(@RequestParam String last_name, @RequestParam String email,
			@RequestParam String first_name, @RequestParam String city, @RequestParam String password) {
...
//  public String test(@RequestBody String last_name)
//  {
